...
func TestExample_renderPage(t *testing.T) {
...
func TestExample_solution10A(t *testing.T) {
...
func TestExample_solution10B(t *testing.T) {
...
func TestExample_solution10C(t *testing.T) {
	// startGame :: IO String
	startGame := F.Pipe2(
		IOO.Of(game),
